var app = new Vue({
    el: "#products",
    data: {
        products: [{ id: 1, title: "Banana1", short_text: 'Cavendish', image: 'images/Cavendish.png', desc: "Burpless is a popular cucumber variety that is known for its mild flavor and crisp texture. It is seedless and has a thin skin, making it a great choice for salads or pickling though they are not considered pickling cucumbers." },
        { id: 2, title: "Banana2", short_text: 'Lady Finger', image: 'images/lady finger.png', desc: "Chinese cucumbers, also known as Mao gourd, are long and slender with a bumpy skin. They have a slightly sweet flavor and are often used in Chinese cuisine. Chinese cucumbers are perfect for adding texture to salads or as a garnish." },
        { id: 3, title: "Banana3", short_text: 'Manzano', image: 'images/Manzano.png', desc: "This cucumber with an elongated name only grows to about 5-6 inches. This small white cucumber does not look at all like a cucumber with a much rounder shape. They are generally used as a slicing cucumber and not often pickled." },
        { id: 4, title: "Banana4", short_text: 'Blue Java', image: 'images/blue java.png', desc: "Armenian cucumbers, also known as snake cucumbers or yard-long cucumbers, are long and thin with a pale green skin and few seeds. They have a mild, sweet flavor and a crunchy texture. Armenian cucumbers are a popular choice for salads and sandwiches, but they can also be used for pickling. They are often harvested when they are about 12 inches or so as they quickly become bitter with growth." },
        { id: 5, title: "Banana5", short_text: 'Red Banana', image: 'images/red-banana.png', desc: "English cucumbers, also known as seedless cucumbers or hot house cucumbers, are long and narrow with a thin skin and few seeds.They are usually wrapped in plastic to protect them during transport and storage. English cucumbers are a popular choice for salads and sandwiches because of their mild flavor and crunchy texture. They are also great for pickling because they hold their shape well. Together with American cucumbers, English cucumbers are the two most commonly available cucumbers at most groceries." }],
        btnVisible: 0,
        product: { },
        cart: [],
        contactFields: [],
